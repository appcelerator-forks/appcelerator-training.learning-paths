...
>![image001.png](../assets/tips/tip.gif) **TIP:** Read the official [Android fundamentals](http://developer.android.com/guide/topics/fundamentals.html) docs.
...
>![image001.png](..../assets/tips/info.png) **NOTE:** To get the ActionBar style menu, you just need to build with a current SDK, which is the default.
